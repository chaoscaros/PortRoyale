...
个人学习、自娱自乐与技术研究项目。高度参考《海商王3》的玩法结构与节奏，以 Web 原生代码重新实现。本仓库当前实现 Phase 1.5 Hero视觉重制：哈瓦那英雄港、双桅船、共享PBR材质、正式HUD与海面光照；不含贸易、经济或战斗，运行验收状态见 AI_HANDOFF。
...
左键拖动旋转、右键拖动平移、滚轮缩放。HUD 提供暂停/继续及 1×/2×/4×；F3 开关开发者信息，底部可聚焦舰队/哈瓦那/全海图。模型 GLB 已提交，正常启动不需要 Blender。
